            ...
            <form method="POST" action="{{ route('admin.lessons.store') }}" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('short_text') ? 'is-invalid' : '' }}" type="text"
                        name="short_text" id="short_text" value="{{ old('short_text', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('full_text') ? 'is-invalid' : '' }}" type="text"
                        name="full_text" id="full_text" value="{{ old('full_text', '') }}">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control {{ $errors->has('position') ? 'is-invalid' : '' }}" type="number"
                        name="position" id="position" value="{{ old('position', '') }}" step="1" required>
