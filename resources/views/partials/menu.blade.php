<div id="sidebar" class="c-sidebar c-sidebar-fixed c-sidebar-lg-show">
    ...
    <ul class="c-sidebar-nav">
        ...
        @endcan
        @can('questionsoption_access')
            <li class="c-sidebar-nav-item">
                <a href="{{ route('admin.questionsoptions.index') }}"
                    class="c-sidebar-nav-link {{ request()->is('admin/questionsoptions') || request()->is('admin/questionsoptions/*') ? 'c-active' : '' }}">
